...
INSERT into IPTV.MONTHLY_ACCOUNT_ERRORS partition (DT_MONTHLY)
...
GROUP BY cast(from_unixtime(CAST(error_raw_elt_solaris_vw.`TIMESTAMP` / 1000 AS BIGINT), 'yy-MM') AS STRING)
