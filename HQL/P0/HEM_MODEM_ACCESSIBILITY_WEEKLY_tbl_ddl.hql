DROP TABLE IF EXISTS HEM.MODEM_ACCESSIBILITY_WEEKLY;
CREATE TABLE HEM.MODEM_ACCESSIBILITY_WEEKLY(
   ...
   DOWNTIME_ALL                STRING        COMMENT   'Total number of seconds the modem was down in a WEEK period (includes maintenance window)',
 ...
 --  TOTAL_TIME_FULL           INT        COMMENT   'Total number of seconds for full day (excludes maintenance window)',
   ...
   UPTIME_ALL                  STRING        COMMENT   'Total number of seconds the modem was up in a WEEK period (includes maintenance window)',
   UPTIME_FULL                  STRING        COMMENT   'Total number of seconds the modem was up in a WEEK period (excludes maintenance window)',
   UPTIME_PRIME                  STRING        COMMENT   'Total number of seconds the modem was up in a WEEK period (includes on prime window)',
