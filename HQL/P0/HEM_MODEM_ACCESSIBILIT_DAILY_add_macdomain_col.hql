...
CREATE TABLE HEM.MODEM_ACCESSIBILITY_DAILY(
   ...
   DOWNTIME_ALL_DAY            INT        COMMENT   'Total number of seconds the modem was down in a 24 hours period (includes maintenance window)',
   TOTAL_TIME_ALL_DAY          INT        COMMENT   'Total number of seconds in 24 hours period (includes maintenance window)',
   ACCESSIBILITY_PERC_ALL_DAY  DOUBLE     COMMENT   'Modem uptime percentage in 24 hours period (includes maintenance window)',
   ...
   DOWNTIME_FULL_DAY           INT        COMMENT   'Total number of seconds modem was down for full day (excludes maintenance window)',
   TOTAL_TIME_FULL_DAY         INT        COMMENT   'Total number of seconds for full day (excludes maintenance window)',
   ACCESSIBILITY_PERC_FULL_DAY DOUBLE     COMMENT   'Modem uptime percentage for full day (excludes maintenance window)',
...
SELECT daily.mac,
       ...
       daily.phub,
       daily.shub,
       null as cmts_md_if_index,
       null as cmts_md_if_name,
       daily.node,
       daily.rtn_seg,
       daily.clamshell,
       daily.smt,
       ...
       daily.hdp_update_ts,
       daily.event_date
FROM   HEM.MODEM_ACCESSIBILITY_DAILY_BKP_09102019 daily;
