CREATE TABLE HEM.MODEM_ATTAINABILITY_YEARLY(
 ...
 COUNT_ACTUAL_DS_IMPACT_FULL_DAY    INT	    COMMENT  'No of Actual DownStream Impact',
  COUNT_ACTUAL_DSUS_IMPACT_FULL_DAY  INT     COMMENT  'No of Actual Down and Up Stream Impact',
  COUNT_ACTUAL_US_IMPACT_FULL_DAY   INT	    COMMENT  'No of Actual UpStream Impact full day',
  TOTAL_COUNTERS_FULL_DAY	       INT	    COMMENT  'No of counters on a full day',
  COUNT_ACTUAL_DS_IMPACT_ALL_DAY	   INT	    COMMENT  'No of actual down impact on  all day',
  COUNT_ACTUAL_DSUS_IMPACT_ALL_DAY  INT	    COMMENT  'No of actual down and up stream impact on a all day',
  COUNT_ACTUAL_US_IMPACT_ALL_DAY	   INT	    COMMENT  'No of  up stream impact on a all day',
  TOTAL_COUNTERS_ALL_DAY	           INT	    COMMENT  'No of counters on all day',
  ...
  DS_SPEED_ATTAINABLE_FULL_DAY	   DOUBLE	COMMENT  'Downstream speed attianble on full day',
  DS_SPEED_ATTAINABLE_ALL_DAY	   DOUBLE	COMMENT  'Downstream speed attianble on all day',
  DS_SPEED_ATTAINABLE_PRIME	       DOUBLE	COMMENT  'Downstream speed attianble on prime',
  US_SPEED_ATTAINABLE_FULL_DAY	   DOUBLE	COMMENT  'Upstream speed attianble on full day',
  US_SPEED_ATTAINABLE_ALL_DAY	   DOUBLE	COMMENT  'Upstream speed attianble on all day',
 ...
 UP_MBYTES                         DOUBLE   COMMENT 'Number of MBytes uploaded ',
 DOWN_MBYTES                       DOUBLE   COMMENT 'Number of MBytes downloaded',
 TOTAL_USG_MBYTES                  DOUBLE   COMMENT 'Number of MBytes used ',
 EVENT_DATE                        INT   COMMENT  'week_start_date date',
