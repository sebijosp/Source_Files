DROP TABLE IF EXISTS HEM.MODEM_SERVICE_QUALITY_WEEKLY;
CREATE TABLE `HEM.MODEM_SERVICE_QUALITY_WEEKLY`(
  ...
  `week_start_date` string COMMENT 'week_start_date date',
...
TBLPROPERTIES (
  'transient_lastDdlTime'='1572377785');
