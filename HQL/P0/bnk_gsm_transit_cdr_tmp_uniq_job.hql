insert into table  cdrdm.bnk_gsm_transit_cdr_tmp_uniq partition(call_timestamp_date='${hiveconf:hive_date}')
select
exchange_identity
,call_type
...
,in_route_name
,out_route_name
from cdrdm.bnk_gsm_transit_cdr_tmp where call_timestamp_date='${hiveconf:hive_date}'
group by
exchange_identity
,call_type
,calling_party_number
