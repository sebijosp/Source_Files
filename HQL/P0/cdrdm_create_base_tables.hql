...
CREATE TABLE cdrdm.FACT_GSM_UNBILLABLE_PP(
subscriber_no BIGINT,
...
CREATE TABLE cdrdm.FACT_GSM_UNBILLABLE(
subscriber_no BIGINT,
...
CREATE TABLE cdrdm.FACT_SMS_CDR(
subscriber_no BIGINT,
...
CREATE TABLE cdrdm.FACT_IUM1205_SMS_DROP(
...
CREATE TABLE cdrdm.FACT_GPRS_CDR(
subscriber_no BIGINT,
subscriber_no_char VARCHAR(20),
...
CREATE TABLE cdrdm.FACT_GPRS_UNBILLABLE(
subscriber_no BIGINT,
subscriber_no_char VARCHAR(20),
--channel_seizure_date STRING, --partition column
channel_seizure_time STRING,
...
CREATE TABLE cdrdm.FACT_TAP3IN_CDR(
...
CREATE TABLE cdrdm.FACT_TAP3_UNBILLABLE(
...
CREATE TABLE cdrdm.FACT_GPRS_MPG_GGSN_CDR(
...
CREATE TABLE cdrdm.FACT_RHPC_DPSCSV_VQ_DAILY(
subscriber_no BIGINT,
drop_code CHAR(4),
rec_des CHAR(8),
hex_id CHAR(2),
...
CREATE TABLE cdrdm.FACT_BOBO_CDR(
...
CREATE TABLE cdrdm.FACT_IMS_CDR(
...
CREATE TABLE cdrdm.FACT_IMS_DROP_CDR(
...
CREATE TABLE cdrdm.FACT_GPRS_SGW_CDR(
recordType BIGINT,
...
CREATE TABLE cdrdm.FACT_SGW_DROP_CDR(
error_codes VARCHAR(40),
...
CREATE TABLE cdrdm.FACT_PGW_DROP_CDR(
ERROR_CODES VARCHAR(40),
...
CREATE TABLE cdrdm.FACT_IMM_CDR(
RecordType CHAR(3),
...
CREATE TABLE cdrdm.FACT_IMM_UNBILLABLE(
SIPMethod VARCHAR(15),
RoleOfNode CHAR(3),
SessionId VARCHAR(200),
CallingPartyAddress VARCHAR(20),
...
CREATE TABLE cdrdm.FACT_RHPS_LD(
subscriber_no BIGINT,
switch_id CHAR(1),
...
CREATE TABLE cdrdm.FACT_GLENAYRE_CDR(
subscriber_no BIGINT,
subscriber_no_char VARCHAR(20),
...
CREATE TABLE cdrdm.FACT_GLENAYRE_UNBILLABLE(
subscriber_no BIGINT,
subscriber_no_char VARCHAR(20),
--channel_seizure_date STRING, --partition column
channel_seizure_time STRING,
...
CREATE TABLE cdrdm.vLesGPRSInfo(
subscriber_no BIGINT,
record_sequence_number INT,
gprs_choice_mask_archive CHAR(4),
served_imsi CHAR(15),
...
Cell_site_name VARCHAR(100), 
Cell_site_City_name VARCHAR(50),
Cell_site_Prov_Name VARCHAR(10),
Cell_site_Address VARCHAR(254),
Cell_site_X VARCHAR(20),
Cell_site_Y VARCHAR(20),
Cell_site_Latitude VARCHAR(25),
Cell_site_Longitude VARCHAR(25),
Cell_decimal VARCHAR(35),
insert_timestamp STRING)
PARTITIONED BY (record_opening_date STRING)
ROW FORMAT DELIMITED FIELDS TERMINATED BY '|'
STORED AS ORC TBLPROPERTIES ("ORC.COMPRESS"="SNAPPY");

CREATE EXTERNAL TABLE ext_ods_usage.usage(
