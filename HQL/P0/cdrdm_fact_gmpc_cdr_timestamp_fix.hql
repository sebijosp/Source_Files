...
CREATE TABLE cdrdm.Z_FACT_GMPC_CDR_Temp(
...
INSERT INTO TABLE cdrdm.Z_FACT_GMPC_CDR_Temp PARTITION (position_date) 
SELECT 
trafficcase,
locationtype,
clientid,
...
responsetime,
substr(requestedpositiontime,1,19) as requestedpositiontime,
subclientno,
clientrequestor,
clientservicetype,
targetms,
numbermsc,
numbersgsn,
substr(positiontime, 1,19) as positiontime,
levelofconfidence,
obtainedaccuracy,
errorcode2,
dialledbyms,
...
insert_timestamp,
position_date
FROM cdrdm.FACT_GMPC_CDR where file_name IN ('FACT_GMPC_CDR');
...
insert_timestamp,
position_date
FROM cdrdm.FACT_GMPC_CDR where file_name NOT IN ('FACT_GMPC_CDR');