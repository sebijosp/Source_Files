...
DROP TABLE IF EXISTS CDRDM.LES_FC_XREF;
 ...
 SELECT DISTINCT FIRST_CELL_COMPLETE,SUBSTR(CALL_DATE,1,10), CALL_TIMESTAMP_DATE
 ...
 SELECT DISTINCT LAST_CELL_COMPLETE,SUBSTR(CALL_DATE,1,10), CALL_TIMESTAMP_DATE
