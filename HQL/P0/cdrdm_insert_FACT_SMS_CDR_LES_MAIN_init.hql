...
drop table if exists cdrdm.les_main_fact_sms_cdr_step1;
create table cdrdm.les_main_fact_sms_cdr_step1 stored as orc as
SELECT   
   subscriber_no AS subject_number,
   CASE
   WHEN file_name="FACT_SMS_HISTORY" THEN CAST((CASE WHEN charged_party = 'O' THEN 'IUM Originating SMS Hist'  ELSE 'IUM Terminating SMS Hist' END) AS VARCHAR(40)) ELSE CAST((CASE WHEN charged_party = 'O' THEN 'IUM Originating SMS'  ELSE 'IUM Terminating SMS' END) AS VARCHAR(40)) END AS call_type,
  ...
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201512';
  
  drop table if exists cdrdm.les_main_fact_sms_cdr_step2;
  create table cdrdm.les_main_fact_sms_cdr_step2 stored as orc as
SELECT   
...
FROM cdrdm.les_main_fact_sms_cdr_step1 v_les_hist_all
...
FROM CDRDM.les_main_fact_sms_cdr_step2 LES_DATA;
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201601';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201602';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201603';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201604';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201605';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201606';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201607';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201608';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201609';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201610';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201611';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201612';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201701';
...
SELECT   
   ...
   CAST (NULL AS CHAR(4)) AS subscriptionType, 
    CAST (NULL AS CHAR(2)) AS SRVCCIndicator,
   local_subscriber_date AS call_timestamp_date
  FROM cdrdm.fact_sms_cdr where date_format(local_subscriber_date,'YYYYMM') = '201702';
...
truncate table cdrdm.fact_sms_cdr_stg;
...
SELECT DISTINCT A.first_Cell_complete,SUBSTR(A.CALL_DATE,1,10), A.CALL_TIMESTAMP_DATE
 FROM CDRDM.LES_MAIN A WHERE  A.first_Cell_complete IS NOT NULL AND NOT EXISTS
 (SELECT 1 FROM CDRDM.LES_FC_XREF B
 WHERE B.SRC_TABLE_NAME = 'LES_MAIN'
 AND B.CALL_TIMESTAMP_DATE = A.CALL_TIMESTAMP_DATE
 AND B.FIRST_Cell = A.FIRST_Cell_complete)
 ;
 
 INSERT INTO CDRDM.LES_LC_XREF PARTITION(SRC_TABLE_NAME = 'LES_MAIN',CALL_TIMESTAMP_DATE)
 SELECT DISTINCT A.Last_Cell_complete,SUBSTR(A.CALL_DATE,1,10), A.CALL_TIMESTAMP_DATE
 FROM CDRDM.LES_MAIN A WHERE  A.Last_Cell_complete IS NOT NULL AND NOT EXISTS
 (SELECT 1 FROM CDRDM.LES_LC_XREF B
 WHERE B.SRC_TABLE_NAME = 'LES_MAIN'
 AND B.CALL_TIMESTAMP_DATE = A.CALL_TIMESTAMP_DATE
 AND B.Last_Cell = A.Last_Cell_complete)
 ;
 
INSERT OVERWRITE table cdrdm.DIM_CELL_SITE_INFO_LATEST_STG
SELECT * FROM (SELECT *, ROW_NUMBER() OVER (PARTITION BY cgi_hex ORDER BY file_date DESC) AS rank_file_date FROM cdrdm.DIM_CELL_SITE_INFO) X WHERE X.rank_file_date=1;
