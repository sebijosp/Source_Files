...
create external table if not exists ext_cdrdm.SOM_INITIATE_CDR(
EVENT_TIME 	STRING,
NME_CLASS	STRING,
NME_TYPE	STRING,
CTN	STRING,
...
create table if not exists CDRDM.SOM_INITIATE_CDR
(
EVENT_TIME      STRING,
NME_CLASS       STRING,
NME_TYPE        STRING,
...
!echo loading the table CDRDM.SOM_INITIATE_CDR;

INSERT INTO TABLE CDRDM.SOM_INITIATE_CDR PARTITION(EVENT_DATE)
SELECT
EVENT_TIME,
NME_CLASS, 
NME_TYPE,  
