...
--cast(sub_no as char(10)),
NULL,
NULL,
cast(CONCAT(substr(answer_time,1,2),':',substr(answer_time,3,2),':',substr(answer_time,5,2)) as STRING) as answer_time,
NULL,
NULL,
NULL,
NULL,
...
FROM cdrdm.dpsamasc0028 a ${hiveconf:WHERE_clause}
