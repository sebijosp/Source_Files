...
AND
 (a.file_name not like '%_mst.dat' AND a.file_name not like '%_sf.dat' AND a.file_name not like 'dpsama_csv_dps99%') ; 
...
IN (SELECT b.subscriber_no from ela_v21.subscriber b))
and a.file_name like '%_sf.dat' 
and CONCAT(SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim(cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),1,4),'-',SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim (cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),5,2),'-',SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim (cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),7,2))>=trunc(add_months(current_date,-13),'MM')) ;


INSERT INTO TABLE cdrdm.FACT_RHP_MANUAL PARTITION (field_date)
SELECT
CONCAT(cast(activating_NPA as char(3)),cast(activating_Number as char(7))) as subscriber_no,
drop_code,
rec_des,
...
CONCAT(SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim(cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),1,4),'-',SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim (cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),5,2),'-',SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim (cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),7,2)) as field_date
FROM cdrdm.dpsamasc0096 a  ${hiveconf:WHERE_clause}
AND a.file_name like 'dpsama_csv_dps99%'  ; 
...
and a.file_name like '%_sf.dat' and CONCAT(SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim(cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),1,4),'-',SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim (cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),5,2),'-',SUBSTR(CONCAT('2',(substr(('0200000'),1,7 - length(trim (cast(field_date as char(5)))))),trim(cast(field_date as char(5)))),7,2))>=trunc(add_months(current_date,-13),'MM'));
