...
class_feature_code,
farend_overseas_ind,
CONCAT(substr(farEnd_NPA,1,5),substr(farEnd_Number,1,7)),
cast(CONCAT(substr(field_time,1,2),':',substr(field_time,3,2),':',substr(field_time,5,2)) as STRING),
class_functions,
...
FROM cdrdm.dpsamasc1030 a ${hiveconf:WHERE_clause} and a.file_name like '%_mst.dat' ;
