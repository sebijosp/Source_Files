...
FROM cdrdm.dpsamasc1030 a  ${hiveconf:WHERE_clause}
AND
((CONCAT(cast(a.activating_NPA as char(3)),cast(a.activating_Number as char(7))) not in (SELECT b.subscriber_no from ela_v21.subscriber b))
