...
--0.3 - humane - 04/18/2017 - implement fix for  CONV(<string>,<Int:Number>, <Int:Number>) UDF error that occurs with certain datasets in Production
...
Drop table ext_cdrdm.physical_device;

SET WHERE_clause;

create table ext_cdrdm.physical_device as
...
(
select x.* from (Select servedSubscriptionID, triggerTime from cdrdm.occ1205ascii a ${hiveconf:WHERE_clause}) w join
(select imsi, ban, subscriber_no, effective_Date, esn_seq_no from ela_v21.physical_device where eq_type='G')x
...
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778238|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778238|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778238|' ) + 1),'\\|')[1])), NULL) AS Gy_Charg_Charact,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778226|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778226|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778226|' ) + 1),'\\|')[1])), NULL) AS Gy_Charging_Id,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778233|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778233|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778233|' ) + 1),'\\|')[1])), NULL) AS Gy_GGSN_MCC_MNC,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778232|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778232|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778232|' ) + 1),'\\|')[1])), NULL) AS Gy_IMSI_MCC_MNC,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778234|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778234|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778234|' ) + 1),'\\|')[1])), NULL) AS Gy_NSAPI,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778227|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778227|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778227|' ) + 1),'\\|')[1])), NULL) AS Gy_PDP_Type,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778240|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778240|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778240|' ) + 1),'\\|')[1])), NULL) AS Gy_RAT_Type,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778239|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778239|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778239|' ) + 1),'\\|')[1])), NULL) AS Gy_SGSN_MCC_MNC,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778237|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778237|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778237|' ) + 1),'\\|')[1])), NULL) AS Gy_Selection_Mode,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778236|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778236|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778236|' ) + 1),'\\|')[1])), NULL) AS Gy_Sess_Stop_Ind,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778231|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778231|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778231|' ) + 1),'\\|')[1])), NULL) AS Gy_CG_Address,
...
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778251|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778251|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778251|' ) + 1),'\\|')[1])), NULL) AS Gy_Cell_Identity,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778332|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778332|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778332|' ) + 1),'\\|')[1])), NULL) AS Gy_ECID,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778253|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778253|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778253|' ) + 1),'\\|')[1])), NULL) AS Gy_Routing_Area_Code,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778252|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778252|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778252|' ) + 1),'\\|')[1])), NULL) AS Gy_Service_Area_Code,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778333|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778333|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778333|' ) + 1),'\\|')[1])), NULL) AS Gy_Tracking_Area_Code,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778250|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778250|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778250|' ) + 1),'\\|')[1])), NULL) AS Gy_Location_Area_Code,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778249|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778249|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778249|' ) + 1),'\\|')[1])), NULL) AS Gy_Location_MCC_MNC,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778230|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778230|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778230|' ) + 1),'\\|')[1])), NULL) AS Gy_GGSN_Address,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778242|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778242|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778242|' ) + 1),'\\|')[1])), NULL) AS Gy_NAS_Port,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778228|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778228|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778228|' ) + 1),'\\|')[1])), NULL) AS Gy_PDP_Address,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778241|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778241|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778241|' ) + 1),'\\|')[1])), NULL) AS Gy_PDP_Context_Type,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778254|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778254|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778254|' ) + 1),'\\|')[1])), NULL) AS Gy_Rating_Group,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778229|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778229|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778229|' ) + 1),'\\|')[1])), NULL) AS Gy_SGSN_Address,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778243|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778243|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778243|' ) + 1),'\\|')[1])), NULL) AS Gy_IMEISV,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778265|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778265|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778265|' ) + 1),'\\|')[1])), NULL) AS Gy_QoS_Class_Iden,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778258|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778258|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778258|' ) + 1),'\\|')[1])), NULL) AS Gy_Max_Req_Band_UL,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778257|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778257|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778257|' ) + 1),'\\|')[1])), NULL) AS Gy_Max_Req_Band_DL,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778406|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778406|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778406|' ) + 1),'\\|')[1])), NULL) AS Gy_Guaran_Bitrate_UL,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778407|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778407|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778407|' ) + 1),'\\|')[1])), NULL) AS Gy_Guaran_Bitrate_DL,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778408|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778408|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778408|' ) + 1),'\\|')[1])), NULL) AS Gy_Bearer_Identifier,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778259|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778259|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778259|' ) + 1),'\\|')[1])), NULL) AS Gy_Priority_Level,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778260|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778260|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778260|' ) + 1),'\\|')[1])), NULL) AS Gy_Pre_emption_Capability,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778261|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778261|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778261|' ) + 1),'\\|')[1])), NULL) AS Gy_Pre_emption_Vulnerability,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778409|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778409|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778409|' ) + 1),'\\|')[1])), NULL) AS Gy_APN_Agg_Max_Bitrate_UL,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778410|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778410|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778410|' ) + 1),'\\|')[1])), NULL) AS Gy_APN_Agg_Max_Bitrate_DL,
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778411|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778411|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778411|' ) + 1),'\\|')[1])), NULL) AS Gy_Node_Id,
CONCAT('302-720-', CONV(
--start of Gy_Location_Area_Code transformation logic
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778250|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778250|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778250|' ) + 1),'\\|')[1])), NULL)
--end of Gy_Location_Area_Code transform logic
,16,10),'-',CONV( if(
-- Convert (Gy_Cell_Identity or Gy_Service_Area_Code)
--start of Gy_Cell_Identity
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778251|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778251|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778251|' ) + 1),'\\|')[1])), NULL)
--end of Gy_Cell_Identity
is NULL,
--start of Gy_Service_Area_Code
if(INSTR(creditControlRecords_chargingContextSpecific, '|16778252|') > 0 AND INSTR(creditControlRecords_chargingContextSpecific, '|16778252|') is NOT NULL,trim(UPPER(split(substr(creditControlRecords_chargingContextSpecific,INSTR(creditControlRecords_chargingContextSpecific, '|16778252|' ) + 1),'\\|')[1])), NULL)
...
trim(UPPER(SPLIT(SUBSTR(creditControlRecords_chargingContextSpecific, INSTR(creditControlRecords_chargingContextSpecific, '|16778251|') + 1),'\\|')[1])), NULL)
--end of Gy_Cell_Identity
),16,10)
) AS Cell_ID_DEC,
CONCAT('302720',
