...
--Main Fact Table
--INSERT INTO TABLE cdrdm.FACT_CHATR_OCC_CDR_TEMP PARTITION (triggerDate)
SELECT
trim(resultCode),
...
where file_name='STOCC001_FOCC1205_ID182151_T20160910184134_R1651.DAT'  and file_date='2016-09-10';
