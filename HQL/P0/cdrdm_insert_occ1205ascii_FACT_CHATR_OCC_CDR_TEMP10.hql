...
--DROP TABLE IF EXISTS ext_cdrdm.occ1205ascii_phys_device_temp_test;

--Temp table to store IMSI and BAN from ELA_V21.PHYSICAL_DEVICE
--CREATE TABLE IF NOT EXISTS ext_cdrdm.occ1205ascii_phys_device_temp_test AS
...
--Main Fact Table
INSERT INTO TABLE cdrdm.FACT_CHATR_OCC_CDR_TEMP10 PARTITION (triggerDate)
SELECT
trim(resultCode),
...
where file_name='STOCC002_FOCC1205_ID998433_T20160910235734_R939.DAT'  and file_date='2016-09-10';
