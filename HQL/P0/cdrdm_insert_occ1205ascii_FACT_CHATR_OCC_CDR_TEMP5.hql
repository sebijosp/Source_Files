...
--Main Fact Table
INSERT INTO TABLE cdrdm.FACT_CHATR_OCC_CDR_TEMP5 PARTITION (triggerDate)
SELECT
trim(resultCode),
...
where file_name='STOCC001_FOCC1205_ID129453_T20160904235852_R909.DAT'  and file_date='2016-09-04';
