...
trim(called_number),
NULL,
trim(original_called_number),
NULL,
NULL,
NULL,
trim(redirecting_number),
NULL,
fault_code,
--trim(switch_id),
NULL,
...
FROM ext_cdrdm.FACT_GSM_CFR_HIST_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CFR_HIST_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_1 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_2 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_3 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_4 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_5 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_6 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_7 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_8 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_9 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_10 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_11 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_12 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_13 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_14 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_15 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_16 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_17 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_18 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_19 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_20 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_21 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_22 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_23 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_24 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_25 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_26 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_27 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_28 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_29 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_30 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_CF_HIST_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
NULL,
NULL,
'FACT_GSM_IN_SMS_HIST', --file_name
NULL, --record_start
NULL, --record_end
NULL, --record_type
'gsm1205', --family_name
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_1 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_2 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_3 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_4 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_5 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_6 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_7 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_8 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_9 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_10 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_11 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_12 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_13 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_14 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_15 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_16 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_17 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_18 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_19 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_20 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_21 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_22 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_23 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_24 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_25 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_26 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_27 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_28 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_29 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_30 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_SMS_HIST_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
NULL,
NULL,
'FACT_GSM_IN_VOICE_HIST', --file_name
NULL, --record_start
NULL, --record_end
NULL, --record_type
'gsm1205', --family_name
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_1 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_2 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_3 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_4 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_5 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_6 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_7 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_8 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_9 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_10 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_11 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_12 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_13 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_14 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_15 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_16 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_17 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_18 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_19 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_20 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_21 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_22 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_23 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_24 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_25 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_26 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_27 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_28 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_29 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_30 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_IN_VOICE_HIST_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
NULL,
NULL,
'FACT_GSM_OUT_SMS_HIST', --file_name
NULL, --record_start
NULL, --record_end
NULL, --record_type
'gsm1205', --family_name
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_1 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_2 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_3 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_4 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_5 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_6 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_7 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_8 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_9 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_10 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_11 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_12 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_13 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_14 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_15 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_16 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_17 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_18 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_19 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_20 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_21 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_22 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_23 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_24 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_25 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_26 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_27 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_28 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_29 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_30 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_SMS_HIST_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
NULL,
NULL,
'FACT_GSM_OUT_VOICE_HIST', --file_name
NULL, --record_start
NULL, --record_end
NULL, --record_type
'gsm1205', --family_name
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_1 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_2 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_3 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_4 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_5 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_6 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_7 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_8 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_9 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_10 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_11 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_12 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_13 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_14 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_15 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_16 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_17 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_18 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_19 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_20 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_21 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_22 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_23 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_24 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_25 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_26 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_27 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_28 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_29 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_30 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
substr(call_timestamp,1,10) as call_timestamp_date
FROM ext_cdrdm.FACT_GSM_OUT_VOICE_HIST_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
NULL, --num_records
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_1 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_2 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_3 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_4 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_5 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_6 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_7 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_8 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_9 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_10 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_11 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_12 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_13 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_14 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_15 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_16 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_17 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_18 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_19 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_20 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_21 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_22 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_23 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_24 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_25 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_26 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_27 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_28 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_29 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_30 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_31 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
day_date,
SUBSTR(date_1,1,10) as local_subscriber_date
FROM ext_cdrdm.FACT_SMS_HISTORY_32 a LEFT OUTER JOIN cdrdm.dim_time b ON a.time_key = b.time_key;
--WHERE time_key <= TBD
...
NULL, --num_records
EtlCrtTs,
if (SrvcRequestTimeStamp IS NOT NULL, substr(SrvcRequestTimeStamp,1,10),substr(EtlCrtTs,1,10)) as RecordOpeningDate
FROM ext_cdrdm.FACT_IMM_HIST;
--WHERE EtlCrtTs < TBD
