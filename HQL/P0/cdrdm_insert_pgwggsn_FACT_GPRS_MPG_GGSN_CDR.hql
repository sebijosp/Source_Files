...
from (select served_imsi,record_opening_time from cdrdm.pgwggsn a  ${hiveconf:WHERE_clause} ) PGW,
...
if ((length(trim(user_location_information_2)) > 0) ,(CASE WHEN rat_type = 6  THEN  CONCAT(trim(SUBSTR(user_location_information_2,1,3)),'-',trim(SUBSTR(user_location_information_2,4,3)),'-', trim(SUBSTR(user_location_information_2,7,5)),'-',if(length(TRIM(SUBSTR(user_location_information_2,12,7))) >0,CONV(CONCAT(CONV(TRIM(SUBSTR(user_location_information_2,12,7)),10,16),'0',TRIM(SUBSTR(user_location_information_2,19,5))),16,10),' ')) ELSE  CONCAT(trim(SUBSTR(user_location_information_2,1,3)),'-',trim(SUBSTR(user_location_information_2,4,3)),'-', trim(SUBSTR(user_location_information_2,24,5)),'-',if(length(trim(SUBSTR(user_location_information_2,29,5)))>0 and trim(SUBSTR(user_location_information_2,29,5)) is not NULL,trim(SUBSTR(user_location_information_2,29,5)),trim(SUBSTR(user_location_information_2,19,5)))) END),NULL),
...
if ((length(trim(user_location_information_4)) > 0) ,(CASE WHEN rat_type = 6  THEN  CONCAT(trim(SUBSTR(user_location_information_4,1,3)),'-',trim(SUBSTR(user_location_information_4,4,3)),'-', trim(SUBSTR(user_location_information_4,7,5)),'-',if(length(TRIM(SUBSTR(user_location_information_4,12,7))) >0,CONV(CONCAT(CONV(TRIM(SUBSTR(user_location_information_4,12,7)),10,16),'0',TRIM(SUBSTR(user_location_information_4,19,5))),16,10),' ')) ELSE  CONCAT(trim(SUBSTR(user_location_information_4,1,3)),'-',trim(SUBSTR(user_location_information_4,4,3)),'-', trim(SUBSTR(user_location_information_4,24,5)),'-',if(length(trim(SUBSTR(user_location_information_4,29,5)))>0 and trim(SUBSTR(user_location_information_4,29,5)) is not NULL,trim(SUBSTR(user_location_information_4,29,5)),trim(SUBSTR(user_location_information_4,19,5)))) END),NULL),
...
if ((length(trim(user_location_information_5)) > 0) ,(CASE WHEN rat_type = 6  THEN  CONCAT(trim(SUBSTR(user_location_information_5,1,3)),'-',trim(SUBSTR(user_location_information_5,4,3)),'-', trim(SUBSTR(user_location_information_5,7,5)),'-',if(length(TRIM(SUBSTR(user_location_information_5,12,7))) >0,CONV(CONCAT(CONV(TRIM(SUBSTR(user_location_information_5,12,7)),10,16),'0',TRIM(SUBSTR(user_location_information_5,19,5))),16,10),' ')) ELSE  CONCAT(trim(SUBSTR(user_location_information_5,1,3)),'-',trim(SUBSTR(user_location_information_5,4,3)),'-', trim(SUBSTR(user_location_information_5,24,5)),'-',if(length(trim(SUBSTR(user_location_information_5,29,5)))>0 and trim(SUBSTR(user_location_information_5,29,5)) is not NULL,trim(SUBSTR(user_location_information_5,29,5)),trim(SUBSTR(user_location_information_5,19,5)))) END),NULL),
record_Opening_Time,
...
if ((length(trim(user_location_information)) > 0) ,(CASE WHEN rat_type = 6  THEN  CONCAT(TRIM(SUBSTR(user_location_information ,1,3)),'-',TRIM(SUBSTR(user_location_information ,4,3)),'-', trim(SUBSTR(user_location_information,7,5)),'-',if(length(TRIM(SUBSTR(user_location_information,12,7))) >0,CONV(CONCAT(CONV(TRIM(SUBSTR(user_location_information,12,7)),10,16),'0',TRIM(SUBSTR(user_location_information,19,5))),16,10),' ')) ELSE  CONCAT(TRIM(SUBSTR(user_location_information ,1,3)),'-',TRIM(SUBSTR(user_location_information ,4,3)),'-', TRIM(SUBSTR(user_location_information ,24,5)),'-',if(length(trim(SUBSTR(user_location_information ,29,5)))>0 and TRIM(SUBSTR(user_location_information ,29,5)) is not NULL,TRIM(SUBSTR(user_location_information ,29,5)), TRIM(SUBSTR(user_location_information ,19,5)))) END ),NULL),
