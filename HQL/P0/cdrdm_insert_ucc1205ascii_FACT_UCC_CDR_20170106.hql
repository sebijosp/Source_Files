...
if((calling_Party_Address is not NULL) AND length(calling_Party_Address) > 0, if(INSTR(calling_Party_Address,'sip:') > 0, trim(SUBSTR(calling_Party_Address,INSTR(calling_Party_Address,'+') + 1, INSTR(SUBSTR(calling_Party_Address, INSTR(calling_Party_Address,'+') + 1),'@') - 1)), if(InStr(calling_Party_Address,'tel:') > 0, trim(SUBSTR(calling_Party_Address,INSTR(calling_Party_Address,'+') + 1)), if(INSTR(calling_Party_Address,'+') > 0,trim(SUBSTR(calling_Party_Address, INSTR(calling_Party_Address,'+') + 1)),calling_Party_Address))),NULL) as CallingPartyAddress,
trim(called_Party_Address) as CalledPartyAddress_orig,
if((called_Party_Address is not NULL) AND length(called_Party_Address) > 0, if(INSTR(called_Party_Address,'sip:') > 0, trim(SUBSTR(called_Party_Address,INSTR(called_Party_Address,'+') + 1, INSTR(SUBSTR(called_Party_Address, INSTR(called_Party_Address,'+') + 1),'@') - 1)), if(InStr(called_Party_Address,'tel:') > 0, trim(SUBSTR(called_Party_Address,INSTR(called_Party_Address,'+') + 1)), if(INSTR(called_Party_Address,'+') > 0,trim(SUBSTR(called_Party_Address, INSTR(called_Party_Address,'+') + 1)),called_Party_Address))),NULL) as CalledPartyAddress,
...
if(listOfAccessNetworkInformation1 is not NULL and length(listOfAccessNetworkInformation1) > 0,if(split(listOfAccessNetworkInformation1,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation1,'\\|')[4]) > 0,split(listOfAccessNetworkInformation1,'\\|')[4],NULL),NULL) as Lst1ChangeTime,
if(listOfAccessNetworkInformation1 is not NULL and length(listOfAccessNetworkInformation1) > 0,if(split(listOfAccessNetworkInformation1,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation1,'\\|')[5]) > 0,split(listOfAccessNetworkInformation1,'\\|')[5],NULL),NULL) as Lst1ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation2 is not NULL and length(listOfAccessNetworkInformation2) > 0,if(split(listOfAccessNetworkInformation2,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation2,'\\|')[4]) > 0,split(listOfAccessNetworkInformation2,'\\|')[4],NULL),NULL) as Lst2ChangeTime,
if(listOfAccessNetworkInformation2 is not NULL and length(listOfAccessNetworkInformation2) > 0,if(split(listOfAccessNetworkInformation2,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation2,'\\|')[5]) > 0,split(listOfAccessNetworkInformation2,'\\|')[5],NULL),NULL) as Lst2ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation3 is not NULL and length(listOfAccessNetworkInformation3) > 0,if(split(listOfAccessNetworkInformation3,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation3,'\\|')[4]) > 0,split(listOfAccessNetworkInformation3,'\\|')[4],NULL),NULL) as Lst3ChangeTime,
if(listOfAccessNetworkInformation3 is not NULL and length(listOfAccessNetworkInformation3) > 0,if(split(listOfAccessNetworkInformation3,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation3,'\\|')[5]) > 0,split(listOfAccessNetworkInformation3,'\\|')[5],NULL),NULL) as Lst3ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation4 is not NULL and length(listOfAccessNetworkInformation4) > 0,if(split(listOfAccessNetworkInformation4,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation4,'\\|')[4]) > 0,split(listOfAccessNetworkInformation4,'\\|')[4],NULL),NULL) as Lst4ChangeTime,
if(listOfAccessNetworkInformation4 is not NULL and length(listOfAccessNetworkInformation4) > 0,if(split(listOfAccessNetworkInformation4,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation4,'\\|')[5]) > 0,split(listOfAccessNetworkInformation4,'\\|')[5],NULL),NULL) as Lst4ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation5 is not NULL and length(listOfAccessNetworkInformation5) > 0,if(split(listOfAccessNetworkInformation5,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation5,'\\|')[4]) > 0,split(listOfAccessNetworkInformation5,'\\|')[4],NULL),NULL) as Lst5ChangeTime,
if(listOfAccessNetworkInformation5 is not NULL and length(listOfAccessNetworkInformation5) > 0,if(split(listOfAccessNetworkInformation5,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation5,'\\|')[5]) > 0,split(listOfAccessNetworkInformation5,'\\|')[5],NULL),NULL) as Lst5ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation6 is not NULL and length(listOfAccessNetworkInformation6) > 0,if(split(listOfAccessNetworkInformation6,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation6,'\\|')[4]) > 0,split(listOfAccessNetworkInformation6,'\\|')[4],NULL),NULL) as Lst6ChangeTime,
if(listOfAccessNetworkInformation6 is not NULL and length(listOfAccessNetworkInformation6) > 0,if(split(listOfAccessNetworkInformation6,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation6,'\\|')[5]) > 0,split(listOfAccessNetworkInformation6,'\\|')[5],NULL),NULL) as Lst6ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation7 is not NULL and length(listOfAccessNetworkInformation7) > 0,if(split(listOfAccessNetworkInformation7,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation7,'\\|')[4]) > 0,split(listOfAccessNetworkInformation7,'\\|')[4],NULL),NULL) as Lst7ChangeTime,
if(listOfAccessNetworkInformation7 is not NULL and length(listOfAccessNetworkInformation7) > 0,if(split(listOfAccessNetworkInformation7,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation7,'\\|')[5]) > 0,split(listOfAccessNetworkInformation7,'\\|')[5],NULL),NULL) as Lst7ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation8 is not NULL and length(listOfAccessNetworkInformation8) > 0,if(split(listOfAccessNetworkInformation8,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation8,'\\|')[4]) > 0,split(listOfAccessNetworkInformation8,'\\|')[4],NULL),NULL) as Lst8ChangeTime,
if(listOfAccessNetworkInformation8 is not NULL and length(listOfAccessNetworkInformation8) > 0,if(split(listOfAccessNetworkInformation8,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation8,'\\|')[5]) > 0,split(listOfAccessNetworkInformation8,'\\|')[5],NULL),NULL) as Lst8ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation9 is not NULL and length(listOfAccessNetworkInformation9) > 0,if(split(listOfAccessNetworkInformation9,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation9,'\\|')[4]) > 0,split(listOfAccessNetworkInformation9,'\\|')[4],NULL),NULL) as Lst9ChangeTime,
if(listOfAccessNetworkInformation9 is not NULL and length(listOfAccessNetworkInformation9) > 0,if(split(listOfAccessNetworkInformation9,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation9,'\\|')[5]) > 0,split(listOfAccessNetworkInformation9,'\\|')[5],NULL),NULL) as Lst9ChangeTimeNormalized,
...
if(listOfAccessNetworkInformation10 is not NULL and length(listOfAccessNetworkInformation10) > 0,if(split(listOfAccessNetworkInformation10,'\\|')[4] is not null and length(split(listOfAccessNetworkInformation10,'\\|')[4]) > 0,split(listOfAccessNetworkInformation10,'\\|')[4],NULL),NULL) as Lst10ChangeTime,
if(listOfAccessNetworkInformation10 is not NULL and length(listOfAccessNetworkInformation10) > 0,if(split(listOfAccessNetworkInformation10,'\\|')[5] is not null and length(split(listOfAccessNetworkInformation10,'\\|')[5]) > 0,split(listOfAccessNetworkInformation10,'\\|')[5],NULL),NULL) as Lst10ChangeTimeNormalized,
trim(ServiceContextID) AS ServiceContextID,
--Phase 2 changes starts
trim(list_of_subscription_ID1) AS SubscriberE164_orig,
--Phase 2 changes ends
if((list_of_subscription_ID1 is not NULL) AND length(list_of_subscription_ID1) > 0,if(INSTR(split(list_of_subscription_ID1,'\\|')[1],'sip:') > 0,trim(SUBSTR(split(list_of_subscription_ID1,'\\|')[1],INSTR(split(list_of_subscription_ID1,'\\|')[1],'+') + 1,INSTR(SUBSTR(split(list_of_subscription_ID1,'\\|')[1],INSTR(split(list_of_subscription_ID1,'\\|')[1],'+') + 1),'@') - 1)),if(INSTR(split(list_of_subscription_ID1,'\\|')[1],'tel:') > 0,trim(SUBSTR(split(list_of_subscription_ID1,'\\|')[1],INSTR(split(list_of_subscription_ID1,'\\|')[1],'+') + 1)),if(INSTR(split(list_of_subscription_ID1,'\\|')[1],'+') > 0,trim(SUBSTR(split(list_of_subscription_ID1,'\\|')[1],INSTR(split(list_of_subscription_ID1,'\\|')[1],'+') + 1)),split(list_of_subscription_ID1,'\\|')[1]))),NULL) AS SubscriberE164,
...
--End_User_SubsID_CTN LOGIC
if((list_of_subscription_ID12 is not NULL) AND length(list_of_subscription_ID12) > 0, if(INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:pui') > 0, trim(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], 
 --Begin v6 change
if (INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:pui+') >0, INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:pui')+8, INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:pui')+7), INSTR(SUBSTR(split(list_of_subscription_ID12,'\\|')[1],if(INSTR(split(list_of_subscription_ID12,'\\|')[1],'+') > 0, INSTR(split(list_of_subscription_ID12,'\\|')[1],'+')+ 1, +8)),'@') - 1)), 
--End v6 change
if(INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:gp') > 0, trim(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:gp') + 6, INSTR(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:gp') + 6),'@') - 1)), if(INSTR(split(list_of_subscription_ID12,'\\|')[1],'sip:') > 0, trim(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], INSTR(split(list_of_subscription_ID12,'\\|')[1],'+') + 1, INSTR(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], INSTR(split(list_of_subscription_ID12,'\\|')[1],'+') + 1),'@') - 1)), if(INSTR(split(list_of_subscription_ID12,'\\|')[1],'tel:') > 0, trim(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], INSTR(split(list_of_subscription_ID12,'\\|')[1],'+') + 1)), if(INSTR(split(list_of_subscription_ID12,'\\|')[1],'@') > 0, trim(SUBSTR(split(list_of_subscription_ID12,'\\|')[1], 1, INSTR(split(list_of_subscription_ID12,'\\|')[1],'@') - 1)), split(list_of_subscription_ID12,'\\|')[1]))))),NULL) AS End_User_SubsID_CTN,
...
--Phase 2 changes ends
if((requested_Party_Address is not NULL) AND length(requested_Party_Address) > 0,if(INSTR(requested_Party_Address,'sip:') > 0,trim(SUBSTR(requested_Party_Address,INSTR(requested_Party_Address,':') + 1,INSTR(SUBSTR(requested_Party_Address,INSTR(requested_Party_Address,':') + 1),'@') - 1)),if(INSTR(requested_Party_Address,'tel:') > 0,trim(SUBSTR(requested_Party_Address,INSTR(requested_Party_Address,':') + 1)),if(INSTR(requested_Party_Address,'+') > 0,trim(requested_Party_Address),trim(requested_Party_Address)))),NULL) as RequestedPartyAddress,
...
if((mMTelInformation_supplementary_Service_Information1 is not NULL) AND length(mMTelInformation_supplementary_Service_Information1) > 0,if(INSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],'sip:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],':') + 1,INSTR(SUBSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],':') + 1),'@') - 1)),if(INSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],'tel:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],':') + 1)),if(INSTR(Substr(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2], 1,1),'+') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],'+') )),if(length(split(mMTelInformation_supplementary_Service_Information1,'\\|')[2]) > 0,split(mMTelInformation_supplementary_Service_Information1,'\\|')[2],NULL)))),NULL) as MMTelSplmtrySrvcInfo1Redir,
...
if((mMTelInformation_supplementary_Service_Information2 is not NULL) AND length(mMTelInformation_supplementary_Service_Information2) > 0,if(INSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],'sip:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],':') + 1,INSTR(SUBSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],':') + 1),'@') - 1)),if(INSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],'tel:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],':') + 1)),if(INSTR(Substr(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2], 1,1),'+') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],'+') )),if(length(split(mMTelInformation_supplementary_Service_Information2,'\\|')[2]) > 0,split(mMTelInformation_supplementary_Service_Information2,'\\|')[2],NULL)))),NULL) as MMTelSplmtrySrvcInfo2Redir,
...
if((mMTelInformation_supplementary_Service_Information4 is not NULL) AND length(mMTelInformation_supplementary_Service_Information4) > 0,if(INSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],'sip:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],':') + 1,INSTR(SUBSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],':') + 1),'@') - 1)),if(INSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],'tel:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],':') + 1)),if(INSTR(Substr(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2], 1,1),'+') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],'+') )),if(length(split(mMTelInformation_supplementary_Service_Information4,'\\|')[2]) > 0,split(mMTelInformation_supplementary_Service_Information4,'\\|')[2],NULL)))),NULL) as MMTelSplmtrySrvcInfo4Redir,
...
if((mMTelInformation_supplementary_Service_Information5 is not NULL) AND length(mMTelInformation_supplementary_Service_Information5) > 0,if(INSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],'sip:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],':') + 1,INSTR(SUBSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],':') + 1),'@') - 1)),if(INSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],'tel:') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],':') + 1)),if(INSTR(Substr(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2], 1,1),'+') > 0,trim(SUBSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],INSTR(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],'+') )),if(length(split(mMTelInformation_supplementary_Service_Information5,'\\|')[2]) > 0,split(mMTelInformation_supplementary_Service_Information5,'\\|')[2],NULL)))),NULL) as MMTelSplmtrySrvcInfo5Redir,
--Phase 2 changes ends - Modified logic
