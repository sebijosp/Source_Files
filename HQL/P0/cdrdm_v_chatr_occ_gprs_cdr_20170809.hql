...
CAST(subscriber_no AS BIGINT) AS subscriber_no,
...
(uplink_Octets_Unit1 + uplink_Octets_Unit2 + uplink_Octets_Unit3) AS data_volume_uplink_archive,
(downlink_Octets_Unit1 + downlink_Octets_Unit2 + downlink_Octets_Unit3) AS data_volume_downlink_archive,
