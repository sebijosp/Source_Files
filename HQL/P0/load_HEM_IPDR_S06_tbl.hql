!echo ;
!echo Hive : Dropping External Table HEM.IPDR_S06_TEMP;
DROP TABLE IF EXISTS HEM.IPDR_S06_TEMP;

!echo ;
!echo INFO Hive : Creating temporary external table HEM.IPDR_S06_TEMP at /userapps/hem/landing/ipdr_s06;

CREATE EXTERNAL TABLE HEM.IPDR_S06_TEMP (
...
LOCATION '/userapps/hem/landing/IPDR_S06'
tblproperties ("skip.header.line.count"="1");


!echo ;
!echo Hive : Temp Table created;
!echo Hive : Loading data into table HEM.IPDR_S06_TEMP;

set hive.exec.dynamic.partition=true;
set hive.exec.dynamic.partition.mode=nonstrict;

INSERT INTO TABLE HEM.IPDR_S06 PARTITION(PROCESSED_DATE='${hiveconf:ProcessedDate}') 
SELECT
   CMTS_HOST_NAME,
...
FROM HEM.IPDR_S06_TEMP;

!echo ;
!echo Hive : Data loaded into HEM.IPDR_S06;
