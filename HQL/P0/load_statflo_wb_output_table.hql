...
INSERT OVERWRITE TABLE NW_TOWER_USAGE.STATFLO_WB_OUTPUT_PRE
...
FROM ( 
SELECT * FROM NW_TOWER_USAGE.STATFLO_WB_OUTPUT_AND
UNION ALL
SELECT *FROM NW_TOWER_USAGE.STATFLO_WB_OUTPUT_OR 
) A ;

INSERT OVERWRITE TABLE NW_TOWER_USAGE.STATFLO_WB_OUTPUT_SECONDARY
SELECT B.STORE_ID,
  B.CHAIN_CODE,
  B.LOCATION_ID,
  B.BANNER,
...
JOIN
  (SELECT DISTINCT BAN,
	...
	LOCATION_TYPE,
	SQ_FT
  FROM NW_TOWER_USAGE.STATFLO_WB_OUTPUT_PRE
  ) B
ON A.BAN = B.BAN
LEFT JOIN NW_TOWER_USAGE.STATFLO_WB_OUTPUT_PRE C
