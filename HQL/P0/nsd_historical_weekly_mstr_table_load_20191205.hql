...
(select max(ucar_latest.rundt) from ucar.ucar_final ucar_latest where ucar_latest.rundt >='${hiveconf:week_start_date}' and ucar_latest.rundt <='${hiveconf:week_end_date}')) 
...
group by locationco, week_ending;
