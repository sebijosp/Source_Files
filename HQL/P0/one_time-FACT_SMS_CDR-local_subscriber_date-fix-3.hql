...
-- INSERTing records from cdrdm.fact_sms_cdr into TEMP table for period between 2016-01-01 AND 2016-06-30
...
WHERE local_subscriber_date BETWEEN '2016-01-01' AND '2016-06-30'
;
--------------------------------------------------------------------------------------------------
