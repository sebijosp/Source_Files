...
create external table if not exists EXT_MT_PRICING.ROGERS_TVM_RATECARD(
REGION    STRING,
RATE_CARD    STRING,
LINE_TYPE    STRING,
MM_IND    STRING,
...
create table if not exists MT_PRICING.ROGERS_TVM_RATECARD
(
REGION    STRING,
RATE_CARD    STRING,
LINE_TYPE    STRING,
...
!echo loading the table MT_PRICING.ROGERS_TVM_RATECARD;

INSERT OVERWRITE TABLE MT_PRICING.ROGERS_TVM_RATECARD PARTITION(LOAD_DATE)
SELECT
REGION,
RATE_CARD,
LINE_TYPE,
...
FROM
EXT_MT_PRICING.ROGERS_TVM_RATECARD;
