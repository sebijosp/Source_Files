DROP TABLE IF EXISTS MT_PRICING.BASE_PROFILE_SIMULATION;
CREATE TABLE IF NOT EXISTS MT_PRICING.BASE_PROFILE_SIMULATION       
(       
LST_ECID	BIGINT,
BAN	BIGINT,
...
DROP TABLE IF EXISTS MT_PRICING.ROGERS_PAYER_SEGMENT_SIMULATION;
CREATE TABLE IF NOT EXISTS MT_PRICING.ROGERS_PAYER_SEGMENT_SIMULATION
(       
LST_ECID	BIGINT,
BAN	BIGINT,
SUBSCRIBER_NO	VARCHAR(20),
